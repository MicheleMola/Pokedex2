...
class PokedexAPIClient: APIClient {
	...
	func getPokemonList(withOffset offset: Int, andLimit limit: Int, completion: @escaping PokemonListCompletionHandler) {
	...
	func getPokemon(byId id: String, completion: @escaping PokemonDetailCompletionHandler) {
